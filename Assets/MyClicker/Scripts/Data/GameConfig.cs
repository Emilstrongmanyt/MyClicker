...
namespace MyClicker.Data
{
    ...
    public class GameConfig : ScriptableObject
    {
        ...
        public class EconomySettings
        {
            ...
            public int gloryPerBoss = 5;
            public float gloryPerBossPerZone = 0.8f;
            public float mutationPerDecade = 0.55f;
            public float mutationSwiftPerDecade = 0.35f;
            public float unspentGloryOffline = 0.008f;
            public float endlessCycleGrowth = 5.2f;
            public float endlessCycleGoldGrowth = 4.2f;
            public float endlessCycleGloryGrowth = 2.6f;
